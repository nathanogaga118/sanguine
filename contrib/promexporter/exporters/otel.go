...
// OtelRecorder is an interface that defines the methods to record metrics.
...
//go:generate go run github.com/vburenin/ifacemaker -f otel.go -s otelRecorder -i OtelRecorder -p exporters -o otel_generated.go -c "autogenerated file"
...
// nolint: cyclop
func newOtelRecorder(metrics metrics.Handler) OtelRecorder {
	otr := otelRecorder{
		metrics:        metrics,
